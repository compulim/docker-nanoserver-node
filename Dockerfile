...
ADD https://nodejs.org/dist/v7.10.0/node-v7.10.0-win-x64.zip C:\\build\\node-v7.10.0-win-x64.zip

RUN powershell -Command Expand-Archive C:\build\node-v7.10.0-win-x64.zip C:\; Rename-Item C:\node-v7.10.0-win-x64 node
RUN SETX PATH C:\node
